    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> RM <?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
                <h4> <strong>Total Amount: </strong> RM <?php echo $total_amount; ?>/-     </h4>
                <br>
            </div>
        </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5> by Nabila Razali © <?php echo date("Y"); ?> Luxe Drive </h5>
                </div>
            </div>
        </div>
    </footer>
